var cards = ['hinh1', 'hinh2', 'hinh3', 'hinh4', 'hinh5', 'hinh6', 'hinh7'];
var current = null;
var point = 0;
var isPlaying = false;
var running = null;
...
function loadContent() {
  ...
  for (var i = 0; i < cards.length; i++) {
    html += '<div class="grid"> <div class="card" data-name=" ' + cards[i] + ' " onclick="flip(this)"> <div class="back"> <img src="image/' + cards[i] + '.png"> </div> <div class="front"> <img src="image/truoc.png"> </div> </div> </div>';
  }
  $('.wrap').html(html);
